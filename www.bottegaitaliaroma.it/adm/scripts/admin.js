...
$(document).on('click', '#confirm_cover_image', function() {
    ...
    // console.log(img);
    $('.thumbnail-preview-add-cover').attr('style', "background: url('" + img + "?w=400&h=400&fit=crop') no-repeat center center;)");
...
$(document).on('click', '#confirm_featured_image', function() {
    ...
    // $('#selected_image_preview').html('<img style="width:280px" src="' + img + '">');
    console.log(img);
    $('.thumbnail-preview-add-featured').attr('style', "background: url('" + img + "?w=400&h=400&fit=crop') no-repeat center center;)");
...
$('.publish-trigger').click(function(){
    $('#published-input').click(); 
    $('#album_editing_form').submit();
});

$('.pin-trigger').click(function(){
    $('#fixed-input').click(); 
    $('#album_editing_form').submit();
});
