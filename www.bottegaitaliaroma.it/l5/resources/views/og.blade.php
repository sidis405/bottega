...
<meta property="og:url" content="//bottegaitaliaroma.it/news/{{$item->slug}}" />
<meta property="og:description" content="{{$item->excerpt}}" />
<meta property="fb:app_id" content="966242223397117" />
<meta property="og:image" content="//bottegaitaliaroma.it/uploads/{{$item->featuredImage->id}}/{{rawurlencode($item->featuredImage->file_name)}}">
